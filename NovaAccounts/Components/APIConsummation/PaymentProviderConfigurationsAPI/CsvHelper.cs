...
//                 continue;
//
//             // If includedProperties is provided, only include specified properties
...
//         }
//
//         // Handle decimal formatting for amounts
//         if (value is decimal decimalValue)
//         {
//             return decimalValue.ToString("N2");
//         }
//
//         // Handle double formatting for amounts
...
public static class CsvHelper
{
    ...
    private static List<ExportProperty> GetExportProperties<T>(List<string> includedProperties = null)
    {
        ...
        foreach (var prop in allProperties)
        {
            ...
            // Skip if specific properties are specified and this one isn't included
            if (includedProperties != null && !includedProperties.Contains(prop.Name))
                continue;
